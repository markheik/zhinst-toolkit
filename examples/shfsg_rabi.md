...
num_steps_rabi_experiment = 64
num_averages_rabi_experiment = 2 ** 10
...
for qubit in range(number_of_qubits):
    ...
    fig3.suptitle(f"Qubit {qubit}", fontsize=30)
    axs[0].plot(x_axis, np.real(readout_results[qubit] - readout_results[qubit][0]))
    axs[0].set_title("I quadrature [A.U.]", fontsize=20)
    axs[0].set_xlabel("pulse amplitude [A.U.]", fontsize=20)
    axs[0].set_ylabel("quadrature [A.U.]", fontsize=20)
    axs[0].tick_params(axis="both", which="major", labelsize=20)

    axs[1].plot(x_axis, np.imag(readout_results[qubit] - readout_results[qubit][0]))
    axs[1].set_title("Q quadrature [A.U.]", fontsize=20)
    axs[1].set_xlabel("pulse amplitude [A.U.]", fontsize=20)
    axs[1].set_ylabel("quadrature [A.U.]", fontsize=20)
